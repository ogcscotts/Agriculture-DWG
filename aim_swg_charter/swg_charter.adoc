:swg-name: Agriculture Information Model  SWG
...
:approval-date: 2023-05-07
:document-number: 23-009r2
...
|Authors: Ioanna Roussaki, Raul Palma, Arne Berre, Karel Charvat, Piotr Zaborowski, Rob Atkinson
|===
